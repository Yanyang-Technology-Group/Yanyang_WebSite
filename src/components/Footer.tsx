...
import { IPv6Icon, IPv4Icon} from '../components/CustomIcons';
          ...
          <div className="text-center text-xs space-y-2">
            ...
            <div className="flex items-center justify-center gap-3">
              <button
                  ...
                  className="inline-flex items-center gap-1 bg-transparent border-transparent text-muted hover:text-fg transition-colors"
              ...
              <IPv6Icon size={20} weight="bold" className="text-muted/60" />
              <IPv4Icon size={20} weight="bold" className="text-muted/60" />
            </div>
          </div>
        </div>
      </footer>
